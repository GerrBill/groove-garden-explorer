        ...
        {currentTrack && (
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="min-w-0">
              <div className="text-xs font-medium truncate max-w-[100px]">{currentTrack.title}</div>
              <div className="text-xs text-zinc-400 truncate max-w-[100px]">{currentTrack.artist}</div>
            </div>
          </div>
        )}
      </div>
      
      <div className="flex-grow flex justify-center items-center max-w-[600px]">
